...
class FarmsControllerTest < ActionController::TestCase
  ...
  test "should create farm" do
    assert_difference('Farm.count') do
      post :create, farm: { description: @farm.description, farmer_id: @farm.farmer_id, location: @farm.location }
    end
  ...
  test "should update farm" do
    patch :update, id: @farm, farm: { description: @farm.description, farmer_id: @farm.farmer_id, location: @farm.location }
    assert_redirected_to farm_path(assigns(:farm))
  end
