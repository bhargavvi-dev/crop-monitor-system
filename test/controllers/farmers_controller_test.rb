...
class FarmersControllerTest < ActionController::TestCase
  ...
  test "should create farmer" do
    assert_difference('Farmer.count') do
      post :create, farmer: { address: @farmer.address, contact: @farmer.contact, email: @farmer.email, name: @farmer.name }
    end
  ...
  test "should update farmer" do
    patch :update, id: @farmer, farmer: { address: @farmer.address, contact: @farmer.contact, email: @farmer.email, name: @farmer.name }
    assert_redirected_to farmer_path(assigns(:farmer))
  end
